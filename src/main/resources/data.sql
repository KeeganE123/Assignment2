...
('GitHub', 'user4', 'gitsecure', 'https://github.com', 'user4@example.com', 'Development account'),
('LinkedIn', 'user5', 'linkedinpass', 'https://linkedin.com', 'user5@example.com', 'Professional network');